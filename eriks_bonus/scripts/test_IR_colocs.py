...
def main():
    ...
    subprocess.call("rm -rf /users/mgloud/projects/brain_gwas/output/eriks-full-analysis-enhanced-for-stefan/*", shell=True)
    subprocess.call("rm -rf /users/mgloud/projects/insulin_resistance/tmp/*", shell=True)

    kept_data = set([])
    with open("/users/mgloud/projects/insulin_resistance/eriks_bonus/output/t2d-tg-ldl_gwas-t2d-tg-ldl_ir-tissues_gwas-pval1e-05_eqtl-pval1e-05_gwas-window1000000_eqtl-window1_coloc-tests.txt") as f:
        all_data = []
        f.readline()
        for line in f:
...
template = '''
{
        "out_dir_group": "eriks-full-analysis-enhanced-for-stefan",

        "gwas_experiments": 
	{
            "/users/mgloud/projects/insulin_resistance/eriks_bonus/data/formatted/GWAS_HDL_GLGC_EuropeansMaybe.txt.gz": {"ref": "1kgenomes", "gwas_format": "pval_only"},
            "/users/mgloud/projects/insulin_resistance/eriks_bonus/data/formatted/GWAS_T2D_Mahajan_Europeans.txt.gz": {"ref": "1kgenomes", "gwas_format": "pval_only"},
            "/users/mgloud/projects/insulin_resistance/eriks_bonus/data/formatted/GWAS_TG_GLGC_EuropeansMaybe.txt.gz": {"ref": "1kgenomes", "gwas_format": "pval_only"}
	},
