...
kept_traits = c("/users/mgloud/projects/insulin_resistance/data/gwas/formatted/brunas_sumstats/GWAS_FastInsu_adjBMI_MAGIC_Europeans.txt.gz",
		...
		"/users/mgloud/projects/insulin_resistance/data/gwas/formatted/bonus_sumstats/GWAS_MI_adjBMI.txt.gz",
                "/users/mgloud/projects/insulin_resistance/data/gwas/formatted/brunas_sumstats/GWAS_CHD_CARDIoGRAMplusC4D_Mixed.txt.gz")
...
write.table(all_gwas_snps, file="/users/mgloud/projects/insulin_resistance/output/chd/all_gwas_snps.txt", quote=FALSE, col.names=TRUE, row.names=FALSE, sep="\t")
```
...
write.table(all_snp_gene_pairs, file="/users/mgloud/projects/insulin_resistance/output/chd/all_snp_gene_pairs_prefiltering.txt", quote=FALSE, col.names=TRUE, row.names=FALSE, sep="\t")
```
...
write.csv(missing_pairs[c("ref_snp", "feature", "reason_missing")], file="/users/mgloud/projects/insulin_resistance/output/chd/all_missing_pairs_explained.txt", quote=FALSE, sep="\t", col.names=TRUE, row.names=FALSE)
write.csv(results, file="/users/mgloud/projects/insulin_resistance/output/chd/full_coloc_results_qced.txt", quote=FALSE, sep="\t", col.names=TRUE, row.names=FALSE)
```
