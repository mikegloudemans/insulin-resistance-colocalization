...
files = c(
	  ...
	  "/users/mgloud/projects/brain_gwas/output/completed/insulin/2018-11-05_14-13-28.850594_insulin_resistance_perturbations_full/CHD_CARDIoGRAMplusC4D_Mixed_prepared_txt_gz_finemap_clpp_status.txt",
	  "/users/mgloud/projects/brain_gwas/output/completed/insulin/2018-11-05_14-13-28.850594_insulin_resistance_perturbations_full/FastGlu_MAGIC_Europeans_AllSNPs_prepared_txt_gz_finemap_clpp_status.txt",
	  "/users/mgloud/projects/brain_gwas/output/completed/insulin/2018-11-05_14-13-28.850594_insulin_resistance_perturbations_full/FastInsu_adjBMI_MAGIC_Europeans_AllSNPs_prepared_txt_gz_finemap_clpp_status.txt",
	  "/users/mgloud/projects/brain_gwas/output/completed/insulin/2018-11-05_14-13-28.850594_insulin_resistance_perturbations_full/HDL_GCLC_Mixed_prepared_txt_gz_finemap_clpp_status.txt",
	  "/users/mgloud/projects/brain_gwas/output/completed/insulin/2018-11-05_14-13-28.850594_insulin_resistance_perturbations_full/LDL_GCLC_Mixed_prepared_txt_gz_finemap_clpp_status.txt",
	  "/users/mgloud/projects/brain_gwas/output/completed/insulin/2018-11-05_14-13-28.850594_insulin_resistance_perturbations_full/T2D_DIAGRAM_European_prepared_txt_gz_finemap_clpp_status.txt",
	  "/users/mgloud/projects/brain_gwas/output/completed/insulin/2018-11-05_14-13-28.850594_insulin_resistance_perturbations_full/TG_GCLC_Mixed_prepared_txt_gz_finemap_clpp_status.txt",
	  "/users/mgloud/projects/brain_gwas/output/completed/insulin/2018-11-05_14-13-28.850594_insulin_resistance_perturbations_full/WHRadjBMI_GIANT_Mixed_AllSNPs_prepared_txt_gz_finemap_clpp_status.txt")

for (tissue in c("Adipose_Subcutaneous", "Adipose_Visceral_Omentum", "Liver", "Muscle_Skeletal"))
{
	...
	# Filter to include only trait of interest...
	finemap = finemap[finemap$eqtl_file == paste0(tissue, "_allpairs_txt_gz"),]
	...
	ggsave(paste0("/users/mgloud/projects/insulin_resistance/output/insulin_", tissue, "_full_clpp.png"), width = 8, height = 12, units = "in", dpi = 300, limitsize=FALSE)
	...
	write.table(heat, file=paste0("/users/mgloud/projects/insulin_resistance/output/insulin_", tissue, "_matrix.tsv"), quote=FALSE, sep="\t", col.names=TRUE)
	...
	ggsave(paste0("/users/mgloud/projects/insulin_resistance/output/insulin_", tissue, "_with_NAs_clpp.png"), width = 8, height = 12, units = "in", dpi = 300, limitsize=FALSE)

}

# The rest of this will have to be reintegrated later...
