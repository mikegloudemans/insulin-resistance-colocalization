...
def main():
    ...
    subprocess.call("rm -rf /users/mgloud/projects/brain_gwas/output/ir-v8-whr/*", shell=True)
    ...
    for i in range(len(kept_data)):
        ...
        if "WHR-adj-BMI_GIANT_2018.txt.gz" not in test[2]:
            continue
