...
```{r}
results = read.table("/users/mgloud/projects/insulin_resistance/output/full_coloc_results_qced.txt", sep="\t", header=TRUE)
...
results_output = results[c("rsid", "chr", "pos", "locus", "min_gwas_pval", "min_eqtl_pval", "gwas_trait", "eqtl_file", "ensembl", "hgnc", "clpp", "clpp_mod", "n_snps", "all_sig_gwas", "all_sig_eqtl")]
write.table(results_output, "/users/mgloud/projects/insulin_resistance/output/clpp_results_2019-09-09.txt", quote=FALSE, col.names=TRUE, row.names=FALSE, sep="\t")
```
