...
```{r}
results = read.csv("/users/mgloud/projects/insulin_resistance/output/chd/full_coloc_results_qced.txt", sep=",")
...
write.table(results_output, "/users/mgloud/projects/insulin_resistance/output/chd/clpp_results.txt", quote=FALSE, col.names=TRUE, row.names=FALSE, sep="\t")
stopifnot(FALSE)
```
